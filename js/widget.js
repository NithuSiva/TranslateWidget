...
class TraductionController extends WidgetController {
	...
	//async load(link) {
		...
		this.article = new xph().doc(dom).ctx(dom).craft('/html/body/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[3]/div[1]/div[2]/div/span[1]').firstResult; // find interesting things
